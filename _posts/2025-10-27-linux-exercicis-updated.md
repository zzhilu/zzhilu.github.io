...
6️ 把 esportistes 内容追加到 examen.txt  
```bash
...
18️ 显示 personatges 文件中包含 “Iron Man” 的行  
```bash
grep "Iron Man" personatges
```

19️ 创建 versio2 ，去掉含 “Iron Man” 的行  
```bash
